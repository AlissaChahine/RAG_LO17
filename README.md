...
Ce projet est réalisé par un **groupe de 5 étudiants** dans le cadre de l'UV **LO17 (Indexation et Recherche d'Information)** à l'Université de Technologie de Compiègne (UTC).
...
*   [**Feuille de Route & TODO (`todo.md`)**](./markdowns/todo.md) : L'état d'avancement des livrables et la feuille de route pour le rendu écrit final de l'UV.
